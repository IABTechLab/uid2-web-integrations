...
describe('DiiNormalization Tests', () => {
  describe('#isNormalizedPhone', () => {
    test('should return false when phone number is not normalized', () => {
      ...
      testCases.forEach((testCase) => expect(isNormalizedPhone(testCase)).toBeFalsy());
    });
    ...
    test('should return true when phone number is normalized', () => {
      ...
      testCases.forEach((testCase) => expect(isNormalizedPhone(testCase)).toBeTruthy());
    });
  });
  ...
  describe('#normalizeEmail', () => {
    test('should return undefined if email is invalid', () => {
      ...
      testCases.forEach((testCase) => expect(normalizeEmail(testCase)).toBeUndefined());
    });

    test('should return undefined if email has space in between', () => {
      const testCases = ['test test@test.com', 'test@te st.com', 'test test@gmail.com'];
