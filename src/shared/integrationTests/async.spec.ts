...
import { __uid2InternalHandleScriptLoad, sdkWindow, UID2 } from '../../uid2/uid2Sdk';
      ...
      const refreshFailedScenarios = [
        {
          ...
          setApiResponses: () => {
            xhrMock.sendEncodedRefreshApiResponse('error', originalIdentity.refresh_response_key);
          },
        },
        {
